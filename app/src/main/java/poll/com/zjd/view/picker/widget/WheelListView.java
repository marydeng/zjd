...
public class WheelListView extends ListView implements ListView.OnScrollListener, View.OnTouchListener,
    ...
    private void onSelectedCallback() {
        ...
        LogUtils.v("isUserScroll=" + isUserScroll + ", index=" + index + ", item=" + item);
    ...
    private void refreshCurrentPosition() {
        ...
        if (adapter.isLoop() && firstPosition == 0) {
            LogUtils.v("is loop and first visible position is 0");
            return;
        }
        int position;
    ...
    public void onGlobalLayout() {
        ...
        if (childCount > 0 && itemHeightPixels == 0) {
            ...
            LogUtils.v("itemHeightPixels=" + itemHeightPixels);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                LogUtils.v("press down: currentPosition=" + currentPosition);
                break;
            case MotionEvent.ACTION_UP:
                LogUtils.v("press up: currentItem=" + getSelectedItem());
                break;
        }
        return false;
    }
