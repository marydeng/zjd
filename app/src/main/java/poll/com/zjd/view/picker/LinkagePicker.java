package poll.com.zjd.view.picker;
...
import poll.com.zjd.view.picker.adapter.ArrayWheelAdapter;
import poll.com.zjd.view.picker.common.LineConfig;
import poll.com.zjd.view.picker.listener.OnItemPickListener;
import poll.com.zjd.view.picker.listener.OnMoreItemPickListener;
import poll.com.zjd.view.picker.listener.OnMoreWheelListener;
import poll.com.zjd.view.picker.widget.WheelListView;
...
public class LinkagePicker extends WheelPicker {
    ...
    public void setSelectedItem(String firstText, String secondText, String thirdText) {
        ...
        for (int i = 0; i < firstData.size(); i++) {
            ...
            if (ft.contains(firstText)) {
                ...
                LogUtils.v("init select first text: " + ft + ", index:" + selectedFirstIndex);
                break;
            }
        }
        ...
        for (int j = 0; j < secondData.size(); j++) {
            ...
            if (st.contains(secondText)) {
                ...
                LogUtils.v("init select second text: " + st + ", index:" + selectedSecondIndex);
                break;
            }
        }
        ...
        for (int k = 0; k < thirdData.size(); k++) {
            ...
            if (tt.contains(thirdText)) {
                ...
                LogUtils.v("init select third text: " + tt + ", index:" + selectedThirdIndex);
                break;
            }
        }
    }
    ...
    protected int[] getColumnWidths(boolean onlyTwoColumn) {
        LogUtils.v(String.format(java.util.Locale.CHINA, "column weight is: %f-%f-%f"
        ...
        if(wheelModeEnable){
            ...
            firstView.setOnWheelChangeListener(new WheelListView.OnWheelChangeListener() {
                ...
                public void onItemSelected(boolean isUserScroll, int index, String item) {
                    ...
                    LogUtils.v("change second data after first wheeled");
            ...
            secondView.setOnWheelChangeListener(new WheelListView.OnWheelChangeListener() {
                ...
                public void onItemSelected(boolean isUserScroll, int index, String item) {
                    ...
                    LogUtils.v("change third data after second wheeled");
