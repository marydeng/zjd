...
public class DateTimeUtils {
    ...
    public static String getCurDateTime(String format) {
        ...
        try {
            SimpleDateFormat formatter = new SimpleDateFormat(format);
            String timestr = formatter.format(new java.util.Date());
            return timestr;
        } catch (Exception e) {
            return "";
        }
     ...
     * @return 周*
     */
    public static String getWeekStrByCalendar(Calendar calendar) {
    ...
    public static String getWeekStrByInt(int dayIndexOfWeek) {
